...
final class PostProcessorRegistrationDelegate {
	...
	/**
	 * TODO 执行工厂类型的后置处理器，对BeanDefinition进行处理
	 * @param beanFactory
	...
	public static void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory,
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			/**
			 * TODO 用于存放类型为BeanDefinitionRegistryPostProcessor的bean工厂后置处理器。BeanDefinitionRegistry是bean定义的注册中心。用来存放所有的bean定义.
			 *      BeanDefinitionRegistryPostProcessor继承自BeanFactoryPostProcessor
			 */
			List<BeanDefinitionRegistryPostProcessor> registryProcessors = new ArrayList<>();

			/**
			 * TODO 遍历所有的BeanFactoryPostProcessor，将普通的BeanFactoryPostProcessor和BeanDefinitionRegistryPostProcessor区分开.
			 */
			...
			// TODO 保存本次将要执行的BeanDefinitionRegistryPostProcessor.
			List<BeanDefinitionRegistryPostProcessor> currentRegistryProcessors = new ArrayList<>();

			// TODO 下面的for循环中是找出所有实现了PriorityOrdered接口的BeanDefinitionRegistryPostProcessor实现类
			...
			for (String ppName : postProcessorNames) {
				if (beanFactory.isTypeMatch(ppName, PriorityOrdered.class)) {
					...
					// TODO 此处的beanFactory.getBean会根据Bean的类型去创建Bean工厂后置处理器对象，有Bean的创建过程。ConfigurationClassPostProcessor
			...
			// TODO 遍历当前要执行的所有BeanDefinitionRegistryPostProcessor，执行其postProcessBeanDefinitionRegistry方法.
	...
	public static void registerBeanPostProcessors(
		...
		// 根据类型获取所有BeanPostProcessor的BeanName TODO 所以实现了BeanPostProcessor或BeanFactoryPostProcessor的类都需要注入到容器
